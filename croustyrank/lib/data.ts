...
export const restaurants: Restaurant[] = [
  ...
  },
  {
    ...
    isPremium: true,
    verdict: "Validé",
    verdictText: "Le meilleur Tasty Crousty du réseau. Portion honnête, panage qui croque, service rapide. Prouve que la franchise peut tenir la qualité quand elle veut.",
  ...
  },
  {
    ...
    isPremium: false,
    verdict: "Validé",
    verdictText: "Bonne surprise. La pimentée arrache vraiment. Portion généreuse pour Marseille. Attention le soir — la cohérence baisse.",
  ...
  },
  {
    ...
    isPremium: true,
    verdict: "Surcoté",
    verdictText: "La hype TikTok a tout faussé. File d'attente de 40 min pour un crousty qui ramollit pendant que tu attends. Le poulet est correct mais pas exceptionnel.",
  ...
  },
  {
    ...
    isPremium: false,
    verdict: "Surcoté",
    verdictText: "Inconsistant. Parfois excellent, souvent décevant. Le panage colle au riz à mi-chemin. Pour le prix et l'attente, on attendait mieux.",
  ...
  },
  {
    ...
    isPremium: false,
    verdict: "Validé",
    verdictText: "Crousty honnête, pas de chichi. Le staff fait attention à la tenue du plat. Moins de monde que Paris donc le croustillant arrive encore chaud.",
  ...
  },
  {
    ...
    isPremium: false,
    verdict: "Surcoté",
    verdictText: "Correct mais franchement pas à la hauteur de la réputation locale. Panage mou, poulet trop fin. Le prix reste justifié mais on espérait mieux.",
  ...
  },
  {
    ...
    isPremium: false,
    verdict: "Arnaque",
    verdictText: "Le crousty arrive humide. Le poulet sent le réchauffé. La sauce blanche compense mais pas suffisamment. À 9€ on s'attendait à mieux qu'une boîte molle.",
...
export const combos: Combo[] = [
  ...
  { id: "c6", label: "Triple Menace", sauces: ["Blanche", "Pimentée", "Curry"], upvotes: 654, downvotes: 789 },
];
...
export const fauxCroustys: FauxCrousty[] = [
  ...
  { id: "f6", name: "Le Bon Kebab", city: "Nantes", verdict: "Passable", score: 3.1, reviews: 64 },
];
